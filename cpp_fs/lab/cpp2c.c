...
const PublicTransport print_info_int(int i)  // unused int
{
...
/* 
    ...
    *(Minibus *)array[2] = MinibusCreate();
    ...
    // *(Minibus *)array[0]->MinibusDisplay(*array[0]); 
    // array[1]->(Taxi *)TaxiDisplay(*array[1]); 
    // array[2]->(Minibus *)MinibusDisplay(*array[2]); 
